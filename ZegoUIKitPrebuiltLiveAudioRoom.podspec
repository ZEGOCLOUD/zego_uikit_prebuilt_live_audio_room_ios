#
#  Be sure to run `pod spec lint ZegoUIKitPrebuiltLiveAudioRoom.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "ZegoUIKitPrebuiltLiveAudioRoom SDK for iOS by ZEGO"
  ...
  spec.source_files  = "ZegoUIKitPrebuiltLiveAudioRoom","ZegoUIKitPrebuiltLiveAudioRoom/**/*.swift"
  spec.resource_bundle = {'ZegoUIKitPrebuiltLiveAudioRoom' => ['ZegoUIKitPrebuiltLiveAudioRoom/Resource/*.{png}']}
  ...
  spec.dependency 'ZegoUIKit', '>=2.11.6'
  spec.dependency 'ZegoUIKitSignalingPlugin', '2.5.0'
